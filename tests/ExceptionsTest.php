...
class ExceptionsTest extends TestCase
{
    ...
    {
        $this->expectException(\SirikKoster\Breadcrumbs\Exceptions\DuplicateBreadcrumbException::class);
    ...
    {
        $this->expectException(\SirikKoster\Breadcrumbs\Exceptions\InvalidBreadcrumbException::class);
    ...
    {
        $this->expectException(\SirikKoster\Breadcrumbs\Exceptions\ViewNotSetException::class);
